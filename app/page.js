    ...
    <>
      <div className="font-sans bg-gray-50 min-h-screen">
        ...
        <main>
          ...
          {/* Testimonials section — copied from app/testimonials/page.jsx */}
          <section className="bg-gray-50 my-20 relative">
            <div className="container z-10 mx-auto px-4">
              ...
              >
                ...
                >
                  <div className="border border-blue-200 bg-blue-50 py-1.5 px-4 rounded-lg text-sm font-medium text-blue-600">
                    Testimonials
                  </div>
                </motion.div>

                <motion.h2
                  className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tighter mt-5 text-center text-gray-900"
