  ...
  return (
    <div className={`h-full flex flex-col bg-white rounded-xl shadow-lg`}>
      ...
      <div className={`flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50 rounded-t-xl`}>
        ...
        <button
          onClick={clearChat}
          className={`p-2 rounded-lg transition-colors hover:bg-gray-200 text-gray-600 hover:text-gray-900`}
          title="Clear chat"
        >
      ...
      <div className={`p-4 border-t border-gray-200 bg-gray-50 rounded-b-xl`}>
        ...
        <div className="flex flex-wrap gap-2 mt-3">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs transition-colors bg-gray-200 text-gray-700 hover:bg-gray-300`}
            >
              {suggestion}
            </button>
          ))}
