...
const Sidebar = () => (
  <aside className="fixed left-0 top-0 h-full w-20 bg-gray-900 shadow-lg p-4 flex flex-col items-center justify-between text-black font-black">
...
const Header = () => (
  <header className="flex items-center justify-between p-6 bg-white shadow-sm rounded-xl">
    ...
    <div className="flex items-center space-x-4">
      ...
      <div className="flex items-center space-x-2 bg-gray-100 p-2 pr-4 rounded-full">
...
const StatCard = ({ title, value, icon, percentage, color, iconColor }) => (
  <div className={`p-6 rounded-3xl shadow-sm flex-1 ${color}`}>
...
const Dashboard = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pl-24 pr-8 pt-8 pb-8 font-sans text-black">
      <Sidebar />
      <Header />
      <main className="mt-8">
